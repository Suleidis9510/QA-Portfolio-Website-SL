              ...
              <div className="p-8 sm:p-10 text-left">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    QA Functional / QA Automation professional with experience in web, mobile,
                    Android, iOS, tablet applications, API testing, database validation,
                    automation, and AI-assisted QA workflows.
                  </p>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">QA Functional & Automation · Remote – Uruguay</p>
                    </div>
                    <div>
                      <div className="flex items-baseline justify-between gap-2">
                        <p className="font-medium text-sm text-foreground">ANF AC – Autoridad de Certificación</p>
                        <span className="text-xs text-muted-foreground">Nov 2023 – Jun 2025</span>
                      </div>
                      <p className="text-xs text-muted-foreground">Software Tester · Remote – Spain</p>
                    </div>
                  </div>
                </div>
