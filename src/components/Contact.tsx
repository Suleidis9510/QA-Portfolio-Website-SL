      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="mt-4 text-muted-foreground max-w-md mx-auto">
            Open to QA Functional, QA Automation, and AI-assisted QA opportunities.
          </p>
          ...
          >
            ...
            <h3 className="font-semibold text-foreground mb-1">Reach Out</h3>
            <p className="text-sm text-muted-foreground mb-4">
              Feel free to contact me for QA opportunities or collaborations.
            </p>
            <a
              href="mailto:suleidisdanai@gmail.com"
